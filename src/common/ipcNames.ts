const modules = {
  ...
  winMain: {
    ...
    subscription_config_get: 'subscription_config_get',
    subscription_config_update: 'subscription_config_update',
    subscription_list_get: 'subscription_list_get',
    subscription_list_due: 'subscription_list_due',
    subscription_list_create: 'subscription_list_create',
    subscription_list_update: 'subscription_list_update',
    subscription_list_remove: 'subscription_list_remove',
    subscription_sync_ingest: 'subscription_sync_ingest',
    subscription_sync_error: 'subscription_sync_error',
    subscription_task_get: 'subscription_task_get',
    subscription_task_update: 'subscription_task_update',
    subscription_task_retry: 'subscription_task_retry',
    subscription_upload_confirm: 'subscription_upload_confirm',
    subscription_dashboard_get: 'subscription_dashboard_get',
    subscription_disk_info_get: 'subscription_disk_info_get',
    subscription_cd2_copy: 'subscription_cd2_copy',
    subscription_cd2_upload_status: 'subscription_cd2_upload_status',
